        ...
        <footer className="px-4 divide-y  text-gray-800">
            <div className="container flex flex-col justify-between text-white py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-cente">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="white" className="w-8 h-8">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase text-gray-50">Life of Travel</h3>
                        <ul className="space-y-1">
                            <li>
